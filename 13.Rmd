...
We might use `epred` to see how many of our posterior draws support the hypothesis $\operatorname{Pr} (y^\text{new} | \text{income} = 5) > \operatorname{Pr} (y^\text{new} | \text{income} = 4)$.
