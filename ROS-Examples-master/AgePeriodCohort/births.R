...
#' #### Load data
births <- read.table("ROS-Examples-master/AgePeriodCohort/data/white_nonhisp_death_rates_from_1999_to_2013_by_sex.txt", header=TRUE)
...
#' #### Sum it up
pop <- read.csv("ROS-Examples-master/AgePeriodCohort/data/US-EST00INT-ALLDATA.csv")
...
#'
deaton <- read.table("ROS-Examples-master/AgePeriodCohort/data/deaton.txt", header=TRUE)
...
mort_data[[1]] <- read.table("ROS-Examples-master/AgePeriodCohort/data/white_nonhisp_death_rates_from_1999_to_2013_by_sex.txt", header=TRUE)
mort_data[[2]] <- read.table("ROS-Examples-master/AgePeriodCohort/data/white_hisp_death_rates_from_1999_to_2013_by_sex.txt", header=TRUE)
mort_data[[3]] <- read.table("ROS-Examples-master/AgePeriodCohort/data/black_death_rates_from_1999_to_2013_by_sex.txt", header=TRUE)
