...
As a proportion approaches zero or one, the method used above tends to break down. "A standard and reasonable quick correction for constructing a 95% interval when $y$ or $n - y$ is near zero is to use the estimate $\hat p = \frac{y + 2}{n + 4}$ with standard error $\sqrt{\hat p(1 − pˆ)/(n + 4)}$" (p. 52). Here's how this would work when $y = 0$ and $n = 75$.
